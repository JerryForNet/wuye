...
using HuRongClub.Util.WeChat.Model;
using HuRongClub.Util.WeChat.Model.Request;
using HuRongClub.Util.WeChat.Model.Request.SendMessage;
using HuRongClub.Util;
using HuRongClub.Util.WeChat.Helper;

namespace HuRongClub.Util.WeChat
{
    class Program
    {
