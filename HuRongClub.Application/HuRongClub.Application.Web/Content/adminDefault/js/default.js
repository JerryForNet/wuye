$.fn.Tab = function (options) {
    ...
    function addTab(item) {
        ...
        if (item.replace != undefined && item.replace == true) {
            removeTab(item);
        }
...
loadnav = function () {
    ...
    $('#nav li a').click(function () {
        ...
        if (data.Target == "iframe") {
            var cookiePro = $.cookie('property_id');
            var selPro = $("#PropertyTree").attr("data-value");
            if (selPro != cookiePro) {
                $.cookie('property_id', selPro);
            }
...
$(document).ready(function () {
    $("#GoToHome").click(function () {
        tablist.newTab({
            ...
            url: contentPath + "/Home/AdminDefault"
        })
    });
});