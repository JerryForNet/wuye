...
namespace HuRongClub.Application.Web.Areas.TenementManage.Controllers
{
    ...
    /// </summary>
    [HandlerOperateLog]
    public class OptionController : MvcControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult OptionForm()
        {
            return View();
        }
        #endregion
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = optionbll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = optionbll.GetList(queryJson);
