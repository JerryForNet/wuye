...
namespace HuRongClub.Application.Busines.BaseManage
{
    ...
    /// 描 述：Accounts_Users
    /// </summary>
    public class Accounts_UsersBLL
    {
        private Accounts_UsersIService service = new Accounts_UsersService();
        ...
        public IEnumerable<Accounts_UsersEntity> GetPageList(Pagination pagination, string queryJson)
        {
