...
namespace HuRongClub.Application.Busines.TenementManage
{
    ...
    {
        private DevicePartIService service = new DevicePartService();
        ...
        public IEnumerable<DevicePartEntity> GetList(string queryJson)
        {
        ...
        public void CopyDevicePlan(int fromyear,int toyear)
        {
            try
            {
                service.CopyDevicePlan(fromyear, toyear);
            }
            catch (Exception)
            {
                throw;
