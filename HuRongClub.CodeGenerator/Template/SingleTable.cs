using HuRongClub.CodeGenerator.Comm;
using HuRongClub.CodeGenerator.Model;
using HuRongClub.Util;
using System.Collections.Generic;
using System.Data;
using System.Text;

namespace HuRongClub.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    /// 日 期：2016.1.15 9:54
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using HuRongClub.Application.Code;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                {
                    if (dt.Columns.Contains("key") && rowItem["key"].Equals("1"))
                    {
                        keyRow = rowItem;
                    }
            ...
            sb.Append("        {\r\n");
            if (keyRow != null && dt.Columns.Contains("datatype") && (keyRow["datatype"].Equals("varchar") || keyRow["datatype"].Equals("uniqueidentifier")))
            {
            ...
            if (keyRow != null && dt.Columns.Contains("datatype"))
            {
                if (keyRow["datatype"].Equals("varchar") || keyRow["datatype"].Equals("uniqueidentifier"))
                {
                    sb.Append("            this." + baseConfigModel.DataBaseTablePK + " = keyValue;\r\n");
                }
                else if (keyRow["datatype"].Equals("int") || keyRow["datatype"].Equals("smallint"))
                {
                    //int _id = 0;
                    ...
                    sb.Append("            int _id = 0;\r\n");
                    sb.Append("            int.TryParse(keyValue, out _id);\r\n");
                    sb.Append("            this." + baseConfigModel.DataBaseTablePK + " = _id;\r\n");
                }
            }
            else
            {
                sb.Append("            // 主健只能为 uniqueidentifier 或 int \r\n");
            }
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HuRongClub.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HuRongClub.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Data.Repository;\r\n");
            sb.Append("using HuRongClub.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace HuRongClub.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using HuRongClub.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HuRongClub.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Code;\r\n");
            sb.Append("using HuRongClub.Util;\r\n");
            sb.Append("using HuRongClub.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
        ...
        public string IndexBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            if (colModel != null)
            {
                ...
                {
                    switch (entity.formatter)
                    {
                        case "date":
                            sb.Append("                { label: '" + entity.label + "', name: '" + entity.name + "', index: '" + entity.name + "', width: " + entity.width + ", align: '" + entity.align + "',sortable: '" + entity.sortable.ToString().ToLower() + "' " + IsShow_Field(entity.hidden) + " ,formatter: function (cellvalue, options, rowObject) {return formatDate(cellvalue, 'yyyy-MM-dd hh:mm');}},\r\n");
                            break;

                        case "money":
                            sb.Append("                { label: '" + entity.label + "', name: '" + entity.name + "', index: '" + entity.name + "', width: " + entity.width + ", align: '" + entity.align + "',sortable: " + entity.sortable.ToString().ToLower() + " " + IsShow_Field(entity.hidden) + ",formatter: 'number', formatoptions: { thousandsSeparator: '', decimalPlaces: 2 } },\r\n");
                            break;
            ...
            sb.Append("            width: '" + ((baseConfigModel.formModel.width == null) ? 500 : baseConfigModel.formModel.width) + "px',\r\n");
            sb.Append("            height: '" + ((baseConfigModel.formModel.height == null) ? 500 : baseConfigModel.formModel.height) + "px',\r\n");
            ...
            // $("#gridTable").jqGridRowValue("building_id");
        ...
        public string CreateControl(FormFieldModel entity)
        {
            ...
            switch (ControlType)
            {
                ...
                case "datetime"://日期框
                    sbControl.Append("<input id=\"" + ControlId + "\" type=\"text\"  onfocus=\"WdatePicker()\" class=\"form-control input-datepicker\" " + validator_html + "/>");
                    break;
