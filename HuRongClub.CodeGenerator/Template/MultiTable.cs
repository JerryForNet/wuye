    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace HuRongClub.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using HuRongClub.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace HuRongClub.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
                sb.Append("    /// 创 建：" + multiTableConfigModel.CreateUser + "\r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HuRongClub.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace HuRongClub.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + multiTableConfigModel.CreateUser + "\r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace HuRongClub.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + multiTableConfigModel.CreateUser + "\r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using HuRongClub.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace HuRongClub.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + multiTableConfigModel.CreateUser + "\r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HuRongClub.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HuRongClub.Application.Code;\r\n");
            ...
            sb.Append("namespace HuRongClub.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本：HurongClub.Framework V1.0.1\r\n");
            sb.Append("    /// 创 建：" + multiTableConfigModel.CreateUser + "\r\n");
        ...
        public string IndexBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, List<GridColumnModel> gridChildColumnModel)
        {
            ...
            sb.Append("                    colModel: [\r\n");
            foreach (var entity in gridChildColumnModel)
            {
        ...
        public string FormBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> formPrimary, List<GridColumnModel> formDetails)
        {
            ...
            sb.Append("    .bills { overflow: hidden; border-radius: 0px; position: relative; background: #FFFFFF; border: 0px solid rgb(204, 204, 204); box-shadow:none; padding: 0px; }\r\n");
            sb.Append("    .ui-widget-content { border-left: 0px; border-right: 0px; border-bottom: 0px; }");
            sb.Append("</style>\r\n");
